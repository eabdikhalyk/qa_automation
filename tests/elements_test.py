...
class TestElements:
    ...
    class TestRadioButton:
        ...
        #     input_radio = radio_button_page.click_on_radio_buttons()
        #     output_radio = radio_button_page.get_output_result()
        #
        #     assert input_radio == output_radio, 'RadioButton have not selected'

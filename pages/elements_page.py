...
from locators.elements_page_locators import RadioButtonLocators, WebTablePageLocators, ButtonsPageLocators, LinkPageLocators
...
class ButtonsPage(BasePage):
    ...
    def click_on_different_button(self,type_click):
        if type_click == "double":
            ...
            return self.check_clicked_on_the_button(self.locators.OUTPUT_DOUBLE)
        if type_click == 'right':
            self.action_right_click(self.element_is_visible(self.locators.RIGHT_CLICK))
            return self.check_clicked_on_the_button(self.locators.OUTPUT_RIGHT)
        if type_click == 'click':
